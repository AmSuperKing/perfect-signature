<template>
	<view class="lime-signature" v-if="show" :style="[canvasStyle, styles]" ref="limeSignature">
		...
		<canvas v-if="useCanvas2d" class="lime-signature__canvas" :id="canvasId" type="2d"
			:disableScroll="disableScroll" willReadFrequently @touchstart="touchStart" @touchmove="touchMove"
			@touchend="touchEnd"></canvas>
		<canvas v-else :disableScroll="disableScroll" class="lime-signature__canvas" :canvas-id="canvasId"
			:id="canvasId" :width="canvasWidth" :height="canvasHeight" willReadFrequently @touchstart="touchStart" @touchmove="touchMove"
		...
		<canvas v-if="showOffscreen" class="offscreen" canvas-id="offscreen" id="offscreen"
			...
			:height="offscreenSize[1]" willReadFrequently>
		</canvas>
		...
		<!-- #endif -->
		<!-- #ifdef APP-NVUE -->
		<web-view src="/components/lime-signature/hybrid/html/index.html" class="lime-signature__canvas" ref="webview"
